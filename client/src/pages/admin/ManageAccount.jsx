                                        ...
                                        <div className="flex items-center">
                                            ...
                                            `}>
                                                ...
                                                <div className="relative mr-2.5 flex items-center justify-center">
                                                    <span className={`absolute w-2 h-2 rounded-full animate-ping opacity-75 ${
                                                        user.role === 'Implementor' ? 'bg-emerald-400' : 'bg-amber-400'
                                                    }`} />
                                                    <span className={`relative w-1.5 h-1.5 rounded-full ${
                                                        user.role === 'Implementor' ? 'bg-emerald-500 group-hover:bg-white' : 'bg-amber-500 group-hover:bg-white'
