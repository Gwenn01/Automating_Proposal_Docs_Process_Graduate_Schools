...
import { User, Mail, MapPin, Briefcase, GraduationCap, LogOut, Edit3, Shield, Calendar, BadgeCheck } from "lucide-react";
...
const ProfileOverview = () => {
  ...
  if (loading) return <div className="min-h-screen bg-slate-50 flex items-center justify-center font-medium text-slate-400">Loading Profile...</div>;
    ...
    return (
      <div className="min-h-screen bg-[#F8FAFC] flex items-center justify-center p-6">
        <div className="max-w-md w-full bg-white p-10 rounded-[2rem] shadow-2xl border border-slate-100 text-center">
          ...
          <p className="text-slate-500 mb-8 font-medium">Please sign in to access your professional dashboard.</p>
        ...
        <div className="bg-white rounded-[2.5rem] shadow-sm border border-slate-200/60 overflow-hidden">
          ...
          <div className="h-44 md:h-60 bg-emerald-900 relative overflow-hidden">
            ...
            <div 
              ...
              style={{ backgroundImage: `url("data:image/svg+xml,%3Csvg width='40' height='40' viewBox='0 0 40 40' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M0 0h20v20H0V0zm10 17L3 10l7-7 7 7-7 7zm10 10l7-7 7 7-7 7-7-7z' fill='%23ffffff' fill-opacity='1' fill-rule='evenodd'/%3E%3C/svg%3E")` }}
            />
          ...
          <div className="px-8 md:px-16 pb-12">
            ...
            <div className="mt-8 md:mt-0 md:ml-10 flex-1 text-center md:text-left md:pb-6">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-50 border border-emerald-100 mb-3">
                  ...
                  <span className="text-[10px] font-black text-emerald-700 uppercase tracking-[0.15em]">Online Now</span>
              </div>
            ...
            <div className="mt-10 md:mt-0 flex items-center gap-4 md:pb-8">
              <button className="flex items-center gap-2 px-7 py-3.5 bg-slate-900 text-white font-bold rounded-2xl hover:bg-slate-800 hover:-translate-y-1 hover:shadow-xl hover:shadow-slate-200 transition-all duration-300 active:scale-95 text-sm">
              ...
              <div className="relative group">
                <div className="flex items-center gap-3 mb-8">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-slate-400 uppercase tracking-[0.2em] mt-1 font-bold">Identity & Contact</p>
                  </div>
                </div>
              ...
              <div className="relative group">
                <div className="flex items-center gap-3 mb-8">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-slate-400 uppercase tracking-[0.2em] mt-1 font-bold">University & Department</p>
                  </div>
                </div>
  ...
  <div className="flex items-center p-4 rounded-2xl bg-slate-50/50 border border-transparent hover:border-slate-200 hover:bg-white hover:shadow-md hover:shadow-slate-100/50 transition-all duration-300 group/item">
    ...
    <div className="ml-4 flex flex-col">
      ...
      {isBadge ? (
        ...
        <span className={`text-[15px] font-bold text-slate-800 ${isCapitalize ? 'capitalize' : ''}`}>
          {value}
        </span>
      )}
    </div>
