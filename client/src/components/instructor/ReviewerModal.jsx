  ...
  try {
    ...
    const cleanedData = {
      ...
      cover: {
        ...
        board_resolution_no:
          editedData.reviews_per_docs?.cover_page?.proposal_summary?.board_resolution || null,
                  ...
                  <div className="space-y-4 font-normal text-base">
                    ...
                    <div className={isEditing ? "bg-blue-50 rounded-lg p-3 space-y-3" : ""}>
                      <p className="text-gray-800">
                        ...
                        ,<span className="inline-block">
                          <EditableText
                            value={normalized?.cover?.proposal_summary?.board_resolution}
                            onChange={(val) => updateField('reviews_per_docs.cover_page.proposal_summary.board_resolution', val)}
                            className="inline"
                            isEditing={isEditing}
                          />
