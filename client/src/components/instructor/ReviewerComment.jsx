...
const ReviewerComment = ({
  ...
  return (
    <div className="w-full mt-6">
      {/* Title */}
      <h2 className="text-lg font-semibold text-gray-900 border-b border-gray-400 pb-1">
        {title}
      </h2>

      <div className="mt-4 bg-gray-50 border border-gray-300 rounded-md p-4 shadow-sm">
        {/* Comment Box */}
